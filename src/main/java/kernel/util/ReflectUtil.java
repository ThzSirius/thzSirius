...
import kernel.annotation.core.Component;
...
public class ReflectUtil {
    ...
    public static Object invokeMethod(Object obj, String methodName, Class<?> paramsClass, Object[] parmas) throws Throwable {
        Object returnValue = null;
        try {
            Method method = obj.getClass().getMethod(methodName, paramsClass);
            returnValue = method.invoke(obj, parmas);
    ...
    public static <T> T createInstance(Class<T> objClass, Class<?>[] paramClass, Object... params) {
        Object obj = null;
        try {
            Constructor constructor = objClass.getConstructor(paramClass);
    ...
    public static boolean existAnyAnnotations(Class objectClass, Class<? extends Annotation>... annotationClasses) {
        for (Class<? extends Annotation> annotation : annotationClasses) {
            if (existAnnotation(objectClass, annotation)) {
                return true;
            }
